...
from data.fashiongen_dataset import  fashiongen_train, fashiongen_eval
...
def create_dataset(dataset, config, min_scale=0.5):
    ...
    elif dataset=='caption_fashiongen':
        train_dataset = fashiongen_train(transform_train, config['image_root'], config['ann_root'], prompt=config['prompt'])
        val_dataset = fashiongen_eval(transform_test, config['image_root'], config['ann_root'], 'val')
        test_dataset = fashiongen_eval(transform_test, config['image_root'], config['ann_root'], 'test')
        return train_dataset, val_dataset, test_dataset
